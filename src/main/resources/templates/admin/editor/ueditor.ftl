<script type="text/javascript" charset="utf-8" src="//${cookieFreeDomain}${base}/dist/js/jquery.form.min.js"></script>
<script type="text/javascript" charset="utf-8" src="//${cookieFreeDomain}${base}/dist/vendors/tinymce/tinymce.min.js"></script>
