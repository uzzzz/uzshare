<script type="text/javascript" charset="utf-8" src="//uzstatic-360cdn.belost.xyz${base}/dist/js/jquery.form.min.js"></script>
<script type="text/javascript" charset="utf-8" src="//uzstatic-360cdn.belost.xyz${base}/dist/vendors/tinymce/tinymce.min.js"></script>
