package uzblog.core.hook.interceptor.desk;

import org.springframework.stereotype.Component;
import org.springframework.web.method.HandlerMethod;
import org.springframework.web.servlet.ModelAndView;

import uzblog.core.hook.interceptor.InterceptorHookSupport;
...
public class IndexControllerHook extends InterceptorHookSupport {
    ...
    public String[] getInterceptor() {
        String[] n = {"uzblog.web.controller.site.IndexController"};
        return n;
    }
